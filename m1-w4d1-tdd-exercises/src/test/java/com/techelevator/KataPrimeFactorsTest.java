...
public class KataPrimeFactorsTest {
	...
	@Test
	public void testMedNum() {
		int[] result = sut.primeFinder(9240);
		Arrays.sort(result);
		assertArrayEquals(new int[] {2, 2, 2, 3, 5, 7, 11}, result);
	}
	
	@Test
	public void testMedNum2() {
		int[] result = sut.primeFinder(6561);
		Arrays.sort(result);
		assertArrayEquals(new int[] {3, 3, 3, 3, 3, 3, 3, 3}, result);
	}
}
