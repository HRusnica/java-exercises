...
public class FruitTreeTest {
	...
	@Test
	public void testPickingTooManyInTwoSteps() {
		boolean result = sut.pickFruit(4);
		assertEquals(true, result);
		assertEquals(6, sut.getPiecesOfFruitLeft());
	
		result = sut.pickFruit(7);
		assertEquals(false, result);
		assertEquals(6, sut.getPiecesOfFruitLeft());
	}
}
